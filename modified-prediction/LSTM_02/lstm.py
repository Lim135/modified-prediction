...
training_set = pd.concat([maotai.iloc[0:1529 - 300, 3:4],
                          ...
                          yutongkeji.iloc[0:1529 - 300, 3:4]], axis=1).values
...
checkpoint_save_path = "./checkpoint_LSTM/"
...
checkpoint_save_path  += "/LSTM_stock.ckpt"
...
# 参数提取
file = open('./LSTM_stock_weights.txt', 'w')
...
plt.legend()
plt.savefig('LSTM_stock_prediction_plot.png')  # 保存图像为 PNG 格式
